...
if((i < len)){
var k = (ks[i]);
var G__28709 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__28710 = (i + (1));
m = G__28709;
i = G__28710;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__28711 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__28711);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28713 = c;
var G__28713__$1 = (((G__28713 == null))?null:G__28713.prototype);
if((G__28713__$1 == null)){
return null;
} else {
return G__28713__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28715 = c;
var G__28715__$1 = (((G__28715 == null))?null:G__28715.prototype);
if((G__28715__$1 == null)){
return null;
} else {
return G__28715__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__28719__delegate = function (args){
var G__28717 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__28717) : reagent.impl.component.as_element.call(null,G__28717));
};
...
while (G__28720__i < G__28720__a.length) {G__28720__a[G__28720__i] = arguments[G__28720__i + 0]; ++G__28720__i;}
  args = new cljs.core.IndexedSeq(G__28720__a,0,null);
} 
...
var args = cljs.core.seq(arglist__28721);
...
var _STAR_current_component_STAR__orig_val__28723 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__28724 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__28724);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__28723);
}});
...
var c = this;
var G__28728_28730 = goog.object.get(c,"cljsRatom");
if((G__28728_28730 == null)){
} else {
reagent.ratom.dispose_BANG_(G__28728_28730);
}
...
var renders_28731 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_28732 = cljs.core.first(cljs.core.vals(renders_28731));
...
if((cljs.core.count(renders_28731) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_28731))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_28732)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_28732], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__28733 = o;
goog.object.set(G__28733,cljs.core.name(k),v);
...
var name = (function (){var G__28734 = fiber;
var G__28734__$1 = (((G__28734 == null))?null:G__28734.type);
if((G__28734__$1 == null)){
return null;
} else {
return G__28734__$1.displayName;
}
})();
var parent = (function (){var G__28735 = fiber;
if((G__28735 == null)){
return null;
} else {
return G__28735.return;
}
})();
var path = (function (){var G__28736 = parent;
var G__28736__$1 = (((G__28736 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__28736) : reagent.impl.component.fiber_component_path.call(null,G__28736)));
if((G__28736__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28736__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__28738 = c;
if((G__28738 == null)){
return null;
} else {
return goog.object.get(G__28738,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__28739._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__28741 = c;
if((G__28741 == null)){
return null;
} else {
return goog.object.get(G__28741,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__28743 = c;
if((G__28743 == null)){
return null;
} else {
return G__28743._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__28745 = instance;
if((G__28745 == null)){
return null;
} else {
return goog.object.get(G__28745,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__28746 = instance;
if((G__28746 == null)){
return null;
} else {
return G__28746._currentElement;
}
}
})();
var name = (function (){var G__28747 = elem;
var G__28747__$1 = (((G__28747 == null))?null:G__28747.type);
if((G__28747__$1 == null)){
return null;
} else {
return G__28747__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__28749 = elem;
if((G__28749 == null)){
return null;
} else {
return goog.object.get(G__28749,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__28750._owner;
}
}
})();
var path = (function (){var G__28751 = owner;
var G__28751__$1 = (((G__28751 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__28751) : reagent.impl.component.component_path.call(null,G__28751)));
if((G__28751__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28751__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__28752 = c;
var G__28752__$1 = (((G__28752 == null))?null:G__28752.constructor);
if((G__28752__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__28752__$1);
}
}
})();
