...
var G__28772 = o;
goog.object.set(G__28772,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__28773__delegate = function (args){
...
while (G__28774__i < G__28774__a.length) {G__28774__a[G__28774__i] = arguments[G__28774__i + 0]; ++G__28774__i;}
  args = new cljs.core.IndexedSeq(G__28774__a,0,null);
} 
...
var args = cljs.core.seq(arglist__28775);
...
var G__28776 = o;
goog.object.set(G__28776,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__28780 = props;
var G__28780__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28780,cljs.core.cst$kw$id,id):G__28780);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28780__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__28780__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__28781 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28781,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__28781;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28782){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28783__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__28785_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__28785_SHARP_);
}));
} else {
return null;
}
...
var vec__28788 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28788,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28788,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28788,(2),null);
...
var temp__5739__auto___28792 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___28792 == null)){
} else {
var key_28793 = temp__5739__auto___28792;
(jsprops.key = key_28793);
}
...
var temp__5739__auto___28794 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___28794 == null)){
} else {
var key_28795 = temp__5739__auto___28794;
(jsprops.key = key_28795);
}
...
var G__28796 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__28796) : reagent.impl.template.as_element.call(null,G__28796));
} else {
var temp__5739__auto___28797 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___28797 == null)){
} else {
var key_28798 = temp__5739__auto___28797;
(jsprops.key = key_28798);
}
...
var G__28800 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__28800)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__28800)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28801){
var G__28802 = cljs.core.first(seq28801);
var seq28801__$1 = cljs.core.next(seq28801);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28802,seq28801__$1);
}));
...
break;
default:
var G__28808 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__28808;
continue;
...
var ctx = ({});
var vec__28810 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28810,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28810,(1),null);
...
var G__28813 = (cljs.core.count(argv) - first_child);
switch (G__28813) {
case (0):
...
break;
case (1):
var G__28814 = component;
var G__28815 = jsprops;
var G__28816 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__28814,G__28815,G__28816);
